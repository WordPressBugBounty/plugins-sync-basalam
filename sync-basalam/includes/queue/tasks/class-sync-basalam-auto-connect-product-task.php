...
class Sync_basalam_Auto_Connect_Product_Task extends WP_Async_Background_Process
{
    ...
    protected function task($item)
    {
        ...
        $result = $BasalamChecker->check_same_product(null, $page);
        
        if (isset($result['timeout_error']) && $result['timeout_error'] === true) {
            sync_basalam_Logger::debug("صفحه $page به دلیل timeout رد شد و صفحه بعدی برای اتصال محصولات بررسی میشود.");
        }
