    ...
    public function onboardingSteps()
    {
        return [
            1 => [
                ...
                'content' => function () {
                    ob_start();
                    require syncBasalamPlugin()->templatePath('onboarding/step1.php');
                    Settings::getOauthData();
            ...
            2 => [
                ...
                'content' => function () {
                    ob_start();
                    require syncBasalamPlugin()->templatePath('onboarding/step2.php');
            ...
            3 => [
                ...
                'content' => function () {
                    ob_start();
                    require syncBasalamPlugin()->templatePath('onboarding/step3.php');
