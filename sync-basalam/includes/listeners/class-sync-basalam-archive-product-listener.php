...
class Sync_basalam_Archive_Product_Listener extends sync_basalam_Listener implements sync_basalam_Listener_Interface
{
    ...
    public function handle($product_id)
    {
        ...
        $product_operations->archive_exist_product($product_id);
    }
}
